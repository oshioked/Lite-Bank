    ...
    return(
        <SafeAreaView style = {{flex: 1}}>
            ...
            <View style = {styles.topSection}>
                <LinearGradient colors = {['#353544', '#1B1B23']} style = {styles.topSectionContent}>
            ...
            <View style = {styles.transactionSection}>
                ...
                <View style = {styles.transactionCardsContainer}>
                    <TransactionCard style = {styles.tranCard} iconName = "ios-paper-plane" transactionName = "Send Money"/>
